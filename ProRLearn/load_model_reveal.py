...
dataset_path = "../data/reveal_data.csv"
...
for split in ['train', 'validation', 'test']:
    ...
    for data in train_val_test[split]:
        input_example = InputExample(text_a = data['modified_column'], label=int(data['label']))
...
checkpoint = torch.load('../hard_prompt/word2.ckpt')
